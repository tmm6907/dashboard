...
func main() {
	...
	apiRoutes.Get("/feeds", routesHandler.CheckAuthHandler(), routesHandler.GetFeeds)
	apiRoutes.Post("/feeds", routesHandler.CreateFeed)
	apiRoutes.Get("/feeds/find", routesHandler.SearchForFeed)
	apiRoutes.Post("/feeds/follow", routesHandler.FollowFeed)
	apiRoutes.Get("/feeds/items", routesHandler.CheckAuthHandler(), routesHandler.GetFeedItems)
	apiRoutes.Get("/feeds/items/:id", routesHandler.CheckAuthHandler(), routesHandler.GetFeedItem)
