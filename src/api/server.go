...
func main() {
	...
	feedRoutes.Post("/follow", routesHandler.CheckAuthHandler(), routesHandler.CreateAndFollowFeed)
	feedRoutes.Post("/follow/:id", routesHandler.CheckAuthHandler(), routesHandler.FollowFeed)
